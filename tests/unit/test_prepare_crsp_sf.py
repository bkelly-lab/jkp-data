...
# <2003-12-31 -> /1.6; else unchanged. Note 2003-12-31 is *strict* < so that
# exact date gets NO adjustment.
@pytest.mark.parametrize(
    ("d", "divisor"),
    [
        ...
        (date(2003, 12, 30), 1.6),  # last day of the /1.6 window
        (date(2003, 12, 31), 1.0),  # strict < boundary -> unchanged
