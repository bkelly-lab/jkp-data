...
- **C4 — No duplicate helpers:** Flag reimplementations of `safe_div`, `fl_none`, or `collect_and_write`. Check `src/jkp/data/aux_functions.py` for the canonical versions.
