...
- Added a post-correction return screen: Compustat returns above 1000% (`ret` > 10) that survive the price correction are set to null in `gen_returns_df` as residual, unrepairable data errors ([#234](https://github.com/bkelly-lab/jkp-data/pull/234))
